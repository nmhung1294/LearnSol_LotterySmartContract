...
contract CryptoICO is Crypto{
    ...
    uint tokenPrice = 0.0001 ether;  // 1 ETH = 10000 MHT, 1 MHT = 0.0001 ETH
    uint public hardCap = 300 ether;
    uint public raisedAmount; // value - wei
   ...
   receive () payable external{
    ...
    function transferFrom(address from, address to, uint tokens) public override returns (bool success){
        ...
        Crypto.transferFrom(from, to, tokens);  // same as super.transferFrom(to, tokens);
        return true;
